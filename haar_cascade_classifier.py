...
def main(video_source: str, image: str, models_name: str, processed_frame_preview: bool) -> None:
    ...
    classifiers = list()
    for model in models:
        classifiers.append(Classifier(model, video_source = video_source, image = image))

    processes = list()
    for classifier in classifiers:
        processes.append(Process(target = classifier.start, args = (processed_frame_preview,)))
